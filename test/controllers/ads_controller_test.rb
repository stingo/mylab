...
class AdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ad" do
    assert_difference('Ad.count') do
      post ads_url, params: { ad: { description: @ad.description, price: @ad.price, title: @ad.title } }
    end
  ...
  test "should update ad" do
    patch ad_url(@ad), params: { ad: { description: @ad.description, price: @ad.price, title: @ad.title } }
